...
var change_img = document.getElementById('user_picture');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function checkInputs() {
        var allInputsFilled = nameInput.value.trim() !== '' &&
    ...
    numInput.addEventListener('input', checkInputs);
